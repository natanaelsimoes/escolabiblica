...
<div class="row">    
    <div class="col-md-12 text-right">        
        <form id="FrmSearch" class="form-inline" onsubmit="equipe.search(event)">            
...
<div id="lstData" class="row">
    <div class="col-md-12">        
        <?php $_MyCookie->loadView('equipe', 'manage.table', $data['equipe']) ?>        
        <div class="clear"></div>
    </div>
    <div class="col-md-12 text-center">
        <?php $_MyCookie->loadView('equipe', 'pagination', $data) ?>
    </div>
</div>
<nav id="admin-navbar" class="navbar navbar-default navbar-fixed-bottom" role="navigation">    
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="align-center">
        <a href="<?= $_MyCookie->mountLink('administrator', 'equipe', 'add') ?>" class="navbar-link">
